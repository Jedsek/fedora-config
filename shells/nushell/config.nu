...
$env.config = {
  ...
  completions: {
    ...
    external: {
      ...
      max_results: 60 # setting it lower can improve completion performance at the cost of omitting some options
      completer: null # default is `null`, check 'fish_completer' above as an example
    }
  }
